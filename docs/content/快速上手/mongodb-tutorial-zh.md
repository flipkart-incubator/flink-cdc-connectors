...
```下载链接只在已发布的版本上可用```
 ...
 - [flink-sql-connector-mongodb-cdc-2.1.3-fk.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-mongodb-cdc/2.1.3-fk/flink-sql-connector-postgres-cdc-2.1.3-fk.jar)
