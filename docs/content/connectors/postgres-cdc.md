...
Download [flink-sql-connector-postgres-cdc-2.1.3-fk.jar](https://repo1.maven.org/maven2/com/ververica/flink-sql-connector-postgres-cdc/2.1.3-fk/flink-sql-connector-postgres-cdc-2.1.3-fk.jar) and put it under `<FLINK_HOME>/lib/`.
